...
extension VideoFeedViewController {
  ...
  func loadViews() {
    ...
    videoPreviewLooper.clipsToBounds = true
    videoPreviewLooper.layer.cornerRadius = 4.0
...
extension VideoTableViewCell {
  ...
  override func layoutSubviews() {
    ...
    let subtitleYCenter = previewImageView.frame.origin.y + previewImageView.bounds.height + 3/2 * padding
